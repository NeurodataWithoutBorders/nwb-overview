...
:bdg-link-primary:`Documentation <https://docs.sleap.ai/latest/>`
...
SLEAP has developed 
`NDXPoseAdaptor <https://io.sleap.ai/latest/sleap_io.io.nwb.html>`_
...
`Labels.export_nwb <https://io.sleap.ai/latest/sleap_io.model.labels.html#sleap_io.model.labels.Labels.export_nwb>`_ 
